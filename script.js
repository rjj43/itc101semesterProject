const emails = [
  ...
  {
    type: "email",
    from: `Amazon.com <span class="hoverable" data-tooltip="account-alert@amazn-support.com">&lt;no-reply@amazon.com&gt;</span>`,
    subject: "Your Amazon account has been locked",
    body: `<p>Dear Customer,</p>
      <p>We detected suspicious login activity on your Amazon account. For your protection, your account has been temporarily locked.</p>
      <p>To unlock your account, please verify your identity:</p>
      <p><a class="hoverable" data-tooltip="http://www.amaz0n-verify.com/signin" href="#">https://www.amazon.com/ap/signin</a></p>
      <p>If you do not verify within 24 hours, your account will be permanently suspended.</p>
      <p class="sig">Amazon Customer Protection</p>`,
    answer: "phishing",
    explanation: "Website Spoofing — The link text says 'amazon.com' but actually points to 'amaz0n-verify.com' (with a zero). The sender address also uses 'amazn' instead of 'amazon.' This is a classic spoofed website designed to steal your login credentials.",
    attachment: null
  },
  ...
  {
    type: "email",
    from: `DealFinder Alerts <span class="hoverable" data-tooltip="promo@best-deals-finder.biz">&lt;promo@bestdeals.com&gt;</span>`,
    subject: "🔥 PS5 Pro Bundle – $149.99 (94% off!) – Only 3 left!",
    body: `<p>EXCLUSIVE DEAL — Found via Google Shopping:</p>
      <div class="deal-box">
        <div class="deal-title">Sony PS5 Pro + 2 Controllers + 5 Games</div>
        <div class="deal-price"><span class="strikethrough">$849.99</span> → <span class="sale">$149.99</span></div>
        <div class="deal-urgency">⏰ Only 3 remaining at this price!</div>
      </div>
      <p>Secure yours now before they're gone:</p>
      <p><a class="hoverable" data-tooltip="http://best-deals-finder.biz/checkout?item=ps5pro" href="#">Claim Your PS5 Pro Bundle →</a></p>
      <p style="font-size:0.85em; color:#888;">You're receiving this because you searched for PS5 deals.</p>`,
    answer: "phishing",
    explanation: "Search Engine Phishing — This 'deal' appeared as a promoted search result. A $149 PS5 Pro bundle is unrealistically cheap (94% off). The checkout link goes to an unknown .biz domain that will harvest your payment information.",
    attachment: null
  },
